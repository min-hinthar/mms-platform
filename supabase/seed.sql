...
('40463cf4-dbfe-4232-98aa-d8a922555930','3a6e126f-7a4a-4f47-a404-66f100e4aaa8','burmese-fried-rice','Burmese Fried Rice','ပဲပြုတ်ထမင်းကြော်','Stir-fried rice with eggs, onion, garlic, and boiled yellow peas.',1200,'https://ukuzkhuppqwtrdkjqrkv.supabase.co/storage/v1/object/public/menu-photos/40463cf4-dbfe-4232-98aa-d8a922555930/fallback.jpg',true,false,'{egg}','{}'),
...
('d3b48fbc-506f-4cf4-ae5e-dd8d34bf81a9','b8fc8e28-1adc-4ddd-8792-73fe4e320d48','chicken-curry','Chicken Curry (Original / Masala / Coconut)','ကြက်သားဟင်း','Farm-raised chicken curry; masala spicy or sweet coconut option available.',1400,'https://ukuzkhuppqwtrdkjqrkv.supabase.co/storage/v1/object/public/menu-photos/d3b48fbc-506f-4cf4-ae5e-dd8d34bf81a9/photo.jpg',true,false,'{soy}','{popular}'),
...
('fe88c38a-d36b-497a-9a37-582b9dbc9e95','3a6e126f-7a4a-4f47-a404-66f100e4aaa8','coconut-chicken-and-rice','Coconut Chicken & Rice','ကြက်အုန်းထမင်း','Coconut rice with balachaung + Burmese chicken curry cooked in coconut oil.',1700,'https://ukuzkhuppqwtrdkjqrkv.supabase.co/storage/v1/object/public/menu-photos/fe88c38a-d36b-497a-9a37-582b9dbc9e95/photo.jpg',true,false,'{shellfish}','{}'),
('55d6acc1-4dfe-4e1c-8547-9158d7ca28ae','8c069537-e7bc-47cd-a9ee-338539a8f764','coconut-rice','Coconut Rice','အုန်းထမင်း','Coconut-cream cooked rice.',350,'https://ukuzkhuppqwtrdkjqrkv.supabase.co/storage/v1/object/public/menu-photos/55d6acc1-4dfe-4e1c-8547-9158d7ca28ae/photo.jpg',true,false,'{}','{vegan,allergen-reviewed}'),
('f97b16a6-ea42-42a1-9495-778bba281890','2dd45bdd-dc99-443e-b3c9-63c3b0262e10','coffee','Coffee','ကော်ဖီ','Hot or cold coffee, 10 oz.',500,'https://ukuzkhuppqwtrdkjqrkv.supabase.co/storage/v1/object/public/menu-photos/f97b16a6-ea42-42a1-9495-778bba281890/fallback.jpg',true,false,'{dairy}','{}'),
...
('6f7f1c26-a925-49cf-bf68-ef533bd7b73e','2dd45bdd-dc99-443e-b3c9-63c3b0262e10','faluda','Faluda','ဖါလူဒါ','Burmese sundae with pudding, jelly, assorted nuts.',900,'https://ukuzkhuppqwtrdkjqrkv.supabase.co/storage/v1/object/public/menu-photos/6f7f1c26-a925-49cf-bf68-ef533bd7b73e/photo.jpg',true,false,'{tree_nuts,dairy}','{popular}'),
...
('8c1a9bd3-fa11-420b-b505-2866c3461ea0','2fa67ae4-0709-48e8-942d-a37d5ea64e89','mohinga','Mohinga','မုန့်ဟင်းခါး','Traditional fish broth soup with rice noodles, garnishes, bean fritters, egg slices.',1400,'https://ukuzkhuppqwtrdkjqrkv.supabase.co/storage/v1/object/public/menu-photos/8c1a9bd3-fa11-420b-b505-2866c3461ea0/photo.jpg',true,false,'{fish,egg}','{popular}'),
...
('bb17dac2-a4c8-4f2a-b995-7bb3223ac91a','e04ee0c4-10eb-4d26-b065-a0d1fc759391','pickled-tea-salad','Pickled Tea Salad','လက်ဖတ်သုပ်','Pickled tea leaves + lettuce + crispy beans/nuts; includes peanuts + dried shrimp powder.',1400,'https://ukuzkhuppqwtrdkjqrkv.supabase.co/storage/v1/object/public/menu-photos/bb17dac2-a4c8-4f2a-b995-7bb3223ac91a/photo.jpg',true,false,'{peanuts,shellfish}','{vegan-optional,popular}'),
('8a6b004b-d26c-42ee-8b46-df41d2d29d73','48b9ad45-3000-49fe-9c1d-342134f0295f','pinto-beans','Pinto Beans','ပဲရေပွကြော်','Pinto beans stir-fried in Burmese style with onions, garlic, and spices.',1200,'https://ukuzkhuppqwtrdkjqrkv.supabase.co/storage/v1/object/public/menu-photos/8a6b004b-d26c-42ee-8b46-df41d2d29d73/fallback.jpg',true,false,'{}','{vegetarian,allergen-reviewed,vegan-optional}'),
...
('3aca57d6-2826-4e7d-9a40-322bf20d80ae','b8fc8e28-1adc-4ddd-8792-73fe4e320d48','pork-offals-curry','Pork Offals Curry','ဝက်ကလီစာ','Pork offal + intestines + liver in mildly spiced sauce.',1500,'https://ukuzkhuppqwtrdkjqrkv.supabase.co/storage/v1/object/public/menu-photos/3aca57d6-2826-4e7d-9a40-322bf20d80ae/photo.jpg',true,false,'{soy}','{}'),
('9c73efd6-2f03-4132-9269-8db3cb40d900','b8fc8e28-1adc-4ddd-8792-73fe4e320d48','pork-skewers','Pork Skewers','ဝက်သားဒုတ်ထိုး','Slow-cooked pork + intestines + liver in herbal spices; served with dipping sauce.',1500,'https://ukuzkhuppqwtrdkjqrkv.supabase.co/storage/v1/object/public/menu-photos/9c73efd6-2f03-4132-9269-8db3cb40d900/fallback.jpg',true,false,'{}','{allergen-reviewed,popular}'),
...
-- W15 — high-volume dishes the real POS sells that the menu was missing (Jan–Jul 2026 sales).
('0ee160fd-f7e6-40e9-90f8-90f48aef1a5b','e04ee0c4-10eb-4d26-b065-a0d1fc759391','veggie-fritters','Veggie Fritters','အကြော်စုံ','Assorted crispy vegetable fritters — a teahouse classic.',1200,'https://ukuzkhuppqwtrdkjqrkv.supabase.co/storage/v1/object/public/menu-photos/0ee160fd-f7e6-40e9-90f8-90f48aef1a5b/fallback.jpg',true,false,'{gluten_wheat}','{}'),
...
values
 ...
 ('2990030604072','Tomato and Drumstick Curry-400g','ငါးခခြာက်ခရမ်းချဉ်သီးဒန့်တလွန်-400g',520,'grocery_food',true,'canned-fish','Grandma','CF0407',400,'g','{}'::text[],799),
 ...
 ('2990031407153','Boiled Banana Stem (400g)','ငှက်ပျောအူပြုတ်(400g)',520,'grocery_food',true,'canned-vegetables','Grandma','CN0715',400,'g','{}'::text[],699),
 ...
 ('2990030603020','Chickpea Curry','သတ်သတ်လွတ်ကုလားပဲဟင်း-150g',195,'grocery_food',true,'canned-vegetables','Grandma','CF0302',150,'g',array['pe','bean']::text[],399),
 ...
 ('2990071804035','Instant Fresh water fish (150g)','ရေချိုငပိဖျော်ရည်-150g',293,'grocery_food',true,'canned-vegetables','Grandma','GR0403',150,'g',array['ngapi','nga pi','shrimp paste']::text[],399),
 ...
 ('2990071804059','Salted Soy Bean in Tomato Sauce','ခရမ်းချဉ်သီးပဲငပိ',215,'grocery_food',true,'canned-vegetables','Grandma','GR0405',150,'g',array['ngapi','nga pi','shrimp paste','pe','bean']::text[],399),
 ...
 ('2990041803013','Royal D','ရွိုင်ရယ်ဒီ',215,'grocery_food',true,'coffee-drinks','Royal-D','DR0301',null,null,array['kaw phi','coffee mix']::text[],349),
 ...
 ('2990031402066','Tempura Flour, Shwe Late Pyar','ရွှေလိပ်ပြာ အကြော်မှုန့်',156,'grocery_food',true,'cooking','Golden Butterfly','CN0206',150,'g','{}'::text[],249),
 ...
 ('2990031402042','Chickpea Pwdr Rst - Hmwe','မွှေးကုလားပဲဘယာကြော်မှုန့်',156,'grocery_food',true,'cooking','Hmwe','CN0204',150,'g',array['pe','bean']::text[],249),
 ...
 ('2990031403070','Hmwe Roasted Tofu Powder-150g','မွှေးတို့ဟူးမှုန့်-150g',169,'grocery_food',true,'cooking','Hmwe','CN0307',150,'g','{}'::text[],249),
 ('2990031403063','Hnwe Roasted Rice Powder-150g','မွှေးမုန့်ဟင်းခါးအမှုန့်-150g',156,'grocery_food',true,'cooking','Hmwe','CN0306',150,'g',array['mohinga','mohingar','mont hin gar','moh hin ga']::text[],249),
 ('2990031402059','Rice Pwdr Rst - Hmwe','မွှေးဆန်လှော်မှုန့်',156,'grocery_food',true,'cooking','Hmwe','CN0205',150,'g','{}'::text[],249),
 ('2990031402196','Curry Powder - Ka Lar Lay(240g)','ကုလားလေးမဆလာ(240g)',572,'grocery_food',true,'cooking','Kalarlay','CN0219',240,'g','{}'::text[],849),
 ...
 ('2990031409010','Horsegram Soy Pst - Myaing','မြိုင် ပုန်းရည်ကြီး',520,'grocery_food',true,'cooking','Myain','CN0901',170,'g',array['pe','bean']::text[],799),
 ...
 ('2990031402011','Bean Powder Rst (US)','စိန်င်္ဟာ ပဲအကျက်မှုန့်',156,'grocery_food',true,'cooking','Sein Hinthar','CN0201',160,'g',array['pe','bean']::text[],249),
 ...
 ('2990191403026','Butter Bean Rsd','ပဲကြီးလှော်',358,'grocery_food',true,'cooking','Sein Hinthar','SN0302',227,'g',array['pe','bean']::text[],499),
 ...
 ('2990190802028','Fish Sauce(Aoe Tat)-330g','အိုးတက်ငံပြာရည်(330g)',208,'grocery_food',true,'cooking','Sein Hinthar','SH0202',330,'g',array['ngan pya yay','fish sauce']::text[],349),
 ...
 ('2990031403094','Hmwe Soya Chunks','မွှေးအသားတု',644,'grocery_food',true,'health','Hmwe','CN0309',150,'g','{}'::text[],null),
 ...
 ('2990031406026','Bamboo Sprouts (265g)','ရွေပန်းပွင့်မိုးကုတ်မှျစ်ချဉ်',780,'grocery_food',true,'health','Shwe Panpwint','CN0602',265,'g','{}'::text[],null),
 ('2990031406033','Mustard Lvs Soup Inst-Shwe Panpwint','ရွေပန်းပွင့်စွန်တန်',780,'grocery_food',true,'health','Shwe Panpwint','CN0603',265,'g','{}'::text[],null),
 ('2990031406040','Quince Drd (265g)','ရွေပန်းပွင့် ချဉ်စော်ကားသီး',780,'grocery_food',true,'health','Shwe Panpwint','CN0604',265,'g','{}'::text[],null),
 ...
 ('2990130402042','Salted Lemon Fakes','ဇာတိ၀င်္ကအစာကြေဆေး(12pcs)',4160,'retail_nonfood',false,'health','Zar Ti Wun Ka','MD0204',50,'g','{}'::text[],null),
 ('2990130402035','Salted Lemon Fakes-Zi Wa Thu Ka','ဇီ၀သုခလေနိုင်ဆေး(ဇီဝက)',4160,'retail_nonfood',false,'health','ZiWathu ka','MD0203',null,null,'{}'::text[],null),
 ...
 ('2990210201015','Umbrella Pathine 22" Water Proof','ပုသိမ်ထီး ၂၂" ရေစိုခံ',2000,'retail_nonfood',false,'home-personal','Pathein','UB0101',null,null,array['pathein umbrella','hti']::text[],null),
 ('2990210201046','Umbrella Pathine 28"','ပုသိမ်ထီး ၂၈"',2000,'retail_nonfood',false,'home-personal','Pathein','UB0104',null,null,array['pathein umbrella','hti']::text[],null),
 ...
 ('2990190401092','Instant Noodle Sauce(Rakhine Monhti), Eait Sea Sein (300g)','အိမ့်စည်းစိမ်ရခိုင်မုန့်တီ(၁၀ထုတ်)',1950,'grocery_food',true,'noodles-mohinga','Eaint Sisane','SD0109',500,'g',array['monti','mont di','rakhine noodle','monhti']::text[],null),
 ...
 ('2990031405029','Malar Hotpot - Lashio Shan Shan 450g','မာလာဟော့ပေါ့(လားရှိုးရှမ်းရှမ်း)',715,'grocery_food',true,'noodles-mohinga','Lashio Shan Shan','CN0502',480,'g',array['mala','malar']::text[],1249),
 ...
 ('2990031403032','Nan Tha Pyay - Fish Flavor Noodle Sauce','နန်းသပြေ မုန့်ဟင်းခါး',715,'grocery_food',true,'noodles-mohinga','Nan Tapyay','CN0303',300,'g',array['mohinga','mohingar','mont hin gar','moh hin ga']::text[],1249),
 ('2990142201060','Noodle- Ngwe ngan','ငွေငန်းခေါက်ဆွဲ',163,'grocery_food',true,'noodles-mohinga','Ngwe Ngan','NV0106',363,'g',array['noodle','khao swe','kyay oh']::text[],299),
 ...
 ('2990142201077','Noodle Soup 350g, Mawlamyine','မော်လမြိုင်အုန်းနို့ခေါက်ဆွဲခြောက်-350g',520,'grocery_food',true,'noodles-mohinga','Sein Hinthar','NV0107',350,'g',array['noodle','khao swe','kyay oh']::text[],599),
 ('2990142201084','Rice Noodle Soup 500g, Mawlamyine','မော်လမြိုင်မုန့်ဖတ်ခြောက်-350g',520,'grocery_food',true,'noodles-mohinga','Sein Hinthar','NV0108',350,'g','{}'::text[],599),
 ...
 ('2990142201015','Noodle,Shwe Oo Down Brand (336g)','ရွှေဥဒေါင်းခေါက်ဆွဲခြောက်',156,'grocery_food',true,'noodles-mohinga','Shwe Ou Down','NV0101',336,'g',array['noodle','khao swe','kyay oh']::text[],298),
 ('2990142201039','Noodle, Son Nyi Naung','စွန်ညီနောင်ခေါက်ဆွဲ',163,'grocery_food',true,'noodles-mohinga','Son Nyi Naung','NV0103',300,'g',array['noodle','khao swe','kyay oh']::text[],299),
 ...
 ('2990142201046','Noodle, Shwe Joekyar Brand (300g)','ရွှေကြိုးကြာကြက်ဥခေါက်ဆွဲပြား',163,'grocery_food',true,'noodles-mohinga','shwe Kyo Kyar','NV0104',300,'g',array['noodle','khao swe','kyay oh']::text[],299),
 ...
 ('2990160602078','Preserve Fruit, Ar Pu Shar Pu','အာပူလျာပူ-ဇီးအစပ်',715,'grocery_food',true,'preserved-fruit','Ar Pu Shar Pu','PF0207',670,'g',array['zee','zi','plum']::text[],999),
 ...
 ('2990160606076','Damson Plum Prsvd (100g)[red]','မက်မန်းသီး-အေး(red)',208,'grocery_food',true,'preserved-fruit','Aye','PF0607',240,'g',array['zee','zi','plum']::text[],349),
 ('2990160606120','Grape Fruit, Aye Brand (100g)','အေးစပျစ်သီး',78,'grocery_food',true,'preserved-fruit','Aye','PF0612',null,null,'{}'::text[],149),
 ...
 ('2990160606151','Damson Plum Prsvd (Red)Ngwe Nan Taw-240g','မက်မန်းသီး(အနီ) ငွေနန်းတော်-240g',163,'grocery_food',true,'preserved-fruit','Ngwe Nan Taw','PF0615',240,'g',array['zee','zi','plum']::text[],249),
 ('2990160606199','Plum Toffee - Pyi Taing Htaung','ပစ်တိုင်းထောင်ဇီးတော်ဖိ',260,'grocery_food',true,'preserved-fruit','Pyit Tine Taung','PF0619',160,'g',array['zee','zi','plum']::text[],399),
 ...
 ('2990160603075','Tanta Prsved','တမ်းတယိုစုံ',650,'grocery_food',true,'preserved-fruit','Tanta','PF0307',380,'g','{}'::text[],999),
 ...
 ('2990192001085','Damson Plum - Tone Tone','မက်မန်းသီး(Tone Tone)',390,'grocery_food',true,'preserved-fruit','Tone Tone','ST0108',180,'g',array['zee','zi','plum']::text[],649),
 ('2990192001030','Dried Apple-220g (Tone Tone)','နာနတ်သီးခြောက် -220g (Tone Tone)',390,'grocery_food',true,'preserved-fruit','Tone Tone','ST0103',200,'g','{}'::text[],649),
 ('2990192001016','Dried Plam-180g (Tone Tone)','အစေ့လွတ်ဇီးချို -180g (Tone Tone)',390,'grocery_food',true,'preserved-fruit','Tone Tone','ST0101',180,'g',array['zee','zi','plum']::text[],649),
 ('2990192001078','Dried Quince-140(Tone Tone)','ချဉ်စော်ကားသီးခြောက-140(Tone Tone)',390,'grocery_food',true,'preserved-fruit','Tone Tone','ST0107',140,'g','{}'::text[],649),
 ...
 ('2990160606083','Fruits Prsvd - Ya Tha Po','ယိုစုံ - ရသာပို',104,'grocery_food',true,'preserved-fruit','Ya Tha Po','PF0608',null,null,'{}'::text[],149),
 ...
 ('2990021101160','Cake Drd - D Ko','ဒီကို ကိတ်ခြောက်',325,'grocery_food',true,'snacks-sweets','Dko','BK0116',200,'g','{}'::text[],499),
 ...
 ('2990191403040','Crispy Snacks, Sar Kaung Brand ( 200g)','ကောင်းထိုက် ဘယာကြော်',358,'grocery_food',true,'snacks-sweets','Kaung Htike','SN0304',200,'g','{}'::text[],549),
 ('2990031408037','Kaung Htike-Fried Onion','ကောင်းထိုက်ကြက်သွန်ကြော်',293,'grocery_food',true,'snacks-sweets','Kaung Htike','CN0803',200,'g','{}'::text[],449),
 ('2990191403019','Snack Crispy- Kaung Kyike','ကောင်းကြိုက်ဘယာကြော်',358,'grocery_food',true,'snacks-sweets','Kaung Kyaik','SN0301',200,'g','{}'::text[],549),
 ...
 ('2990191405051','kaung Mon Black Sesame Brittle Snacks(220 g)','ကောင်းမွန်နှမ်းနက်ယို',358,'grocery_food',true,'snacks-sweets','Kaung Mon','SN0505',220,'g','{}'::text[],549),
 ...
 ('2990021101061','Nay Win - Butter Bread','နေဝင်းထောပါတ်မုန့်ကြွပ်',358,'grocery_food',true,'snacks-sweets','Nay Win','BK0106',240,'g','{}'::text[],549),
 ...
 ('2990191407024','Sunflower Seed, Point Brand (325g)','ပွိုင့် နေကြာစေ့-325g',429,'grocery_food',true,'snacks-sweets','Point','SN0702',325,'g','{}'::text[],649),
 ('2990021101078','Mixed Berries Cashew Rusk [200g]','ဆာလာမုန့်ကြွပ်',358,'grocery_food',true,'snacks-sweets','Sarlar','BK0107',200,'g','{}'::text[],549),
 ...
 ('2990021101030','Butter Bread Crispy - Shwe Kyee Thaedaw','ရွှေကျီးသဲတော မုန့်ကြွပ်',325,'grocery_food',true,'snacks-sweets','Shwe Kyee','BK0103',250,'g','{}'::text[],499),
 ('2990021101054','Cake Drd - Shwe Kyee','ရွှေကျီးကိတ်ခြောက်',358,'grocery_food',true,'snacks-sweets','Shwe Kyee','BK0105',200,'g','{}'::text[],549),
 ('2990021101085','Crispy Butter Bread','ရွှေကျီး-ရွှေလုံး',897,'grocery_food',true,'snacks-sweets','Shwe Kyee','BK0108',450,'g','{}'::text[],null),
 ('2990021102013','Egg Soft Flour Cake - Shwe Kyee','ရွှေကျီးကြက်ဥမရွေး',286,'grocery_food',true,'snacks-sweets','Shwe Kyee','BK0201',200,'g','{}'::text[],449),
 ('2990021102020','Milk Rusk Sticks(160g)','ရွှေကျီး-နို့မှုန့်ချောင်း (160g)',215,'grocery_food',true,'snacks-sweets','Shwe Kyee','BK0202',160,'g','{}'::text[],349),
 ('2990191407048','Sunflower Seeds- 170g (Swal Naypye)','စွဲနေပြီ နေကြာစေ့ 170g',286,'grocery_food',true,'snacks-sweets','Swal Naypye','SN0704',170,'g','{}'::text[],449),
 ...
 ('2990191405013','Peanut Candy - Yathar Kaung','ရသာကောင်း မြေပဲချိုချဉ်',390,'grocery_food',true,'snacks-sweets','Yathar Kaung','SN0501',300,'g',array['pe','bean']::text[],599),
 ('2990191405020','Sesame Brittle - Yathar Kaung','နှမ်းနက်ယို ရသာကောင်း',286,'grocery_food',true,'snacks-sweets','Yathar Kaung','SN0502',126,'g','{}'::text[],449),
 ...
 ('2990191403071','Crispy Snacks -Ywart Ywart Sat Sat','ရွရွစပ်စပ်အကြော်စုံ',260,'grocery_food',true,'snacks-sweets','Ywart Ywart Sat Sat','SN0307',135,'g','{}'::text[],399),
