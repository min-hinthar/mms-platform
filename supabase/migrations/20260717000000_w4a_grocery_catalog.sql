...
-- SKU, pack size, romanization synonyms — 395 sellable of 396 parsed; CT0403 has no price in any
-- source list and is excluded) and the pg_trgm fuzzy search the W4b Browse tab uses.
