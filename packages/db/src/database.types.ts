// Generated by `supabase gen types typescript` against the MMS QR/Platform project
// (fasnpdhtvqtzjlvruqcu). DO NOT EDIT BY HAND — regenerate after every migration:
//   supabase gen types typescript --project-id fasnpdhtvqtzjlvruqcu > packages/db/src/database.types.ts
