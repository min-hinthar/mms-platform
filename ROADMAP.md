...
- **W6** Front of house — **W6a ✅ (2026-08-05) the register**: walk-up/phone orders exist (`/staff/register`, staff-minted `reg-` sessions + start-a-table), search + the modifier sheet (K17), tendered/change + `#CODE` handoff, day cash summary (`docs/W6A_PLAN.md`) · **W6b ⬜** kiosk shell mode (attract/idle-reset/EN-MY tiles/HID scan/one upsell) · **W6c ⬜** Terminal stays M6·P6.2.
