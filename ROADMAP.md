...
- **W6** Front of house — **W6a ✅ (2026-08-05) the register**: walk-up/phone orders exist (`/staff/register`, staff-minted `reg-` sessions + start-a-table), search + the modifier sheet (K17), tendered/change + `#CODE` handoff, day cash summary (`docs/W6A_PLAN.md`) · **W6b ✅ (2026-08-06) the kiosk shell** (S5 closed — `docs/W6B_PLAN.md`): `/kiosk` device-token surface, attract EN/MY entry, three doors over kiosk- member sessions, forked idle reset, HID wedge, one upsell, pay-at-counter into the register queue · **W6c ⬜** Terminal stays M6·P6.2.
