...
- **Signature moments:** R6 menu — **R6a ✅** browse layer (search · scroll-spy category jump-nav · fail-safe dietary filters · blur-up images · real-tag badges); **R6b ✅** item detail sheet (eager modifiers radio/checkbox · client-preview/server-final live price · required-modifier Choose guard · hardcoded "goes well with" upsell · blur-up photo-hero). · R7 checkout +
