...
- **M3** Faithful reorder ✅ (2026-08-15) — `modifier_option_ids` on cart+order lines, id-threaded add paths, reorder re-prices by stored id with vanished-option disclosure (migration `20260815100000`; 3 new mutants). ⬜ Q10 residual: `modKey`/SQL fold key still label-based.
