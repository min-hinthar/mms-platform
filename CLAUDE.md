...
pnpm verify:slice        # the MECHANICAL pre-PR gate: money-path coverage guard (a changed money
                         ...
                         # + photo-filter grep + gate + 522 mutations + orphan check (a few minutes)
                         # ⚠️ REWRITES the 97 money/authority modules it mutates IN PLACE (87 under
                         ...
                         # ⚠️ 87+3+6+1=97, and THIS ENUMERATION IS THE OPERATOR'S ONLY LIST of files
