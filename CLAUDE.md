...
pnpm verify:slice        # the MECHANICAL pre-PR gate: money-path coverage guard (a changed money
                         ...
                         # + photo-filter grep + gate + 675 mutations + orphan check (a few minutes)
                         # ⚠️ REWRITES the 122 money/authority modules it mutates IN PLACE (109 under
                         ...
                         # ⚠️ 109+3+9+1=122, and THIS ENUMERATION IS THE OPERATOR'S ONLY LIST of files
