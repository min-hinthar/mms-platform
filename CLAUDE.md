...
pnpm verify:slice        # the MECHANICAL pre-PR gate: money-path coverage guard (a changed money
                         ...
                         # + photo-filter grep + gate + 456 mutations + orphan check (a few minutes)
                         # ⚠️ REWRITES the 90 money/authority modules it mutates IN PLACE (80 under
                         ...
                         # ⚠️ 80+3+6+1=90, and THIS ENUMERATION IS THE OPERATOR'S ONLY LIST of files
