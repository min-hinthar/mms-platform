...
pnpm verify:slice        # the MECHANICAL pre-PR gate: money-path coverage guard (a changed money
                         ...
                         # + photo-filter grep + gate + 683 mutations + orphan check (a few minutes)
                         # ⚠️ REWRITES the 124 money/authority modules it mutates IN PLACE (109 under
                         ...
                         # ⚠️ 109+3+11+1=124, and THIS ENUMERATION IS THE OPERATOR'S ONLY LIST of files
