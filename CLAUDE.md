...
pnpm verify:slice        # the MECHANICAL pre-PR gate: money-path coverage guard (a changed money
                         ...
                         # + photo-filter grep + gate + 727 mutations + orphan check (a few minutes)
                         # ⚠️ REWRITES the 126 money/authority modules it mutates IN PLACE (110 under
                         ...
                         # ⚠️ 110+3+12+1=126, and THIS ENUMERATION IS THE OPERATOR'S ONLY LIST of files
