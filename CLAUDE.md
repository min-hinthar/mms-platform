...
pnpm verify:slice        # the MECHANICAL pre-PR gate: money-path coverage guard (a changed money
                         ...
                         # + photo-filter grep + gate + 988 mutations + orphan check (a few minutes)
                         # ⚠️ REWRITES the 158 money/authority modules it mutates IN PLACE (138 under
                         # apps/qr/lib, plus create-share-intent, setup-intent and board routes,
                         # plus SIXTEEN components — TableCartProvider.tsx, menu/YourUsual.tsx,
                         ...
                         # (Phase 2a), staff/TerminalSettle.tsx (Phase 2c), COMPONENTS in the set since M46 — plus
                         # packages/db/src/schemas.ts) and restores them.
                         # ⚠️ 138+3+16+1=158, and THIS ENUMERATION IS THE OPERATOR'S ONLY LIST of files
