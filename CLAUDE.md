...
pnpm verify:slice        # the MECHANICAL pre-PR gate: money-path coverage guard (a changed money
                         ...
                         # + photo-filter grep + gate + 560 mutations + orphan check (a few minutes)
                         # ⚠️ REWRITES the 105 money/authority modules it mutates IN PLACE (95 under
                         ...
                         # ⚠️ 95+3+6+1=105, and THIS ENUMERATION IS THE OPERATOR'S ONLY LIST of files
