...
pnpm verify:slice        # the MECHANICAL pre-PR gate: money-path coverage guard (a changed money
                         ...
                         # + photo-filter grep + gate + 564 mutations + orphan check (a few minutes)
                         # ⚠️ REWRITES the 107 money/authority modules it mutates IN PLACE (96 under
                         # apps/qr/lib, plus create-share-intent, setup-intent and board routes,
                         # plus SEVEN components — TableCartProvider.tsx, menu/YourUsual.tsx,
                         # staff/TicketText.tsx, staff/Chrome.tsx, staff/StaffPromoControl.tsx,
                         # ReadyBoard.tsx and MergeRedeemer.tsx, COMPONENTS in the set since M46 —
                         # plus
                         # packages/db/src/schemas.ts) and restores them.
                         # ⚠️ 96+3+7+1=107, and THIS ENUMERATION IS THE OPERATOR'S ONLY LIST of files
