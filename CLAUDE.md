...
pnpm verify:slice        # the MECHANICAL pre-PR gate: money-path coverage guard (a changed money
                         ...
                         # + photo-filter grep + gate + 547 mutations + orphan check (a few minutes)
                         # ⚠️ REWRITES the 103 money/authority modules it mutates IN PLACE (93 under
                         # apps/qr/lib, plus create-share-intent, setup-intent and board routes,
                         # plus SIX components — TableCartProvider.tsx, menu/YourUsual.tsx,
                         # staff/TicketText.tsx, staff/Chrome.tsx, staff/StaffPromoControl.tsx and
                         # ReadyBoard.tsx, COMPONENTS in the set since M46 — plus
                         # packages/db/src/schemas.ts) and restores them.
                         # ⚠️ 93+3+6+1=103, and THIS ENUMERATION IS THE OPERATOR'S ONLY LIST of files
