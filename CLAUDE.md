...
pnpm verify:slice        # the MECHANICAL pre-PR gate: money-path coverage guard (a changed money
                         ...
                         # + photo-filter grep + gate + 436 mutations + orphan check (a few minutes)
                         # ⚠️ REWRITES the 85 money/authority modules it mutates IN PLACE (75 under
                         ...
                         # ⚠️ 75+3+6+1=85, and THIS ENUMERATION IS THE OPERATOR'S ONLY LIST of files
