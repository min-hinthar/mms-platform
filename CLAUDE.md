...
pnpm verify:slice        # the MECHANICAL pre-PR gate: money-path coverage guard (a changed money
                         ...
                         # + photo-filter grep + gate + 670 mutations + orphan check (a few minutes)
                         # ⚠️ REWRITES the 120 money/authority modules it mutates IN PLACE (107 under
                         ...
                         # ⚠️ 107+3+9+1=120, and THIS ENUMERATION IS THE OPERATOR'S ONLY LIST of files
