...
pnpm verify:slice        # the MECHANICAL pre-PR gate: money-path coverage guard (a changed money
                         ...
                         # + photo-filter grep + gate + 880 mutations + orphan check (a few minutes)
                         # ⚠️ REWRITES the 151 money/authority modules it mutates IN PLACE (132 under
                         ...
                         # ⚠️ 132+3+15+1=151, and THIS ENUMERATION IS THE OPERATOR'S ONLY LIST of files
