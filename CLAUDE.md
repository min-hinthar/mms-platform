...
pnpm verify:slice        # the MECHANICAL pre-PR gate: money-path coverage guard (a changed money
                         ...
                         # + photo-filter grep + gate + 753 mutations + orphan check (a few minutes)
                         # ⚠️ REWRITES the 132 money/authority modules it mutates IN PLACE (116 under
                         # apps/qr/lib, plus create-share-intent, setup-intent and board routes,
                         # plus TWELVE components — TableCartProvider.tsx, menu/YourUsual.tsx,
                         # staff/TicketText.tsx, staff/Chrome.tsx, staff/StaffPromoControl.tsx,
                         # ReadyBoard.tsx, MergeRedeemer.tsx, staff/TableCard.tsx,
                         # AccountUpgrade.tsx, staff/SettledToday.tsx, staff/DayCash.tsx and
                         # Checkout.tsx (M224), COMPONENTS in the set since M46 — plus
                         # packages/db/src/schemas.ts) and restores them.
                         # ⚠️ 116+3+12+1=132, and THIS ENUMERATION IS THE OPERATOR'S ONLY LIST of files
