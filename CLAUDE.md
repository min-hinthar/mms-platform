...
pnpm verify:slice        # the MECHANICAL pre-PR gate: money-path coverage guard (a changed money
                         ...
                         # + photo-filter grep + gate + 363 mutations + orphan check (a few minutes)
                         # ⚠️ REWRITES the 76 money/authority modules it mutates IN PLACE (69 under
                         # apps/qr/lib, plus create-share-intent, setup-intent and board routes, plus
                         # FOUR components — TableCartProvider.tsx, menu/YourUsual.tsx,
                         # staff/TicketText.tsx and staff/Chrome.tsx, the first COMPONENTS in the
