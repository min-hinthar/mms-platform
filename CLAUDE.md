...
pnpm verify:slice        # the MECHANICAL pre-PR gate: money-path coverage guard (a changed money
                         ...
                         # + photo-filter grep + gate + 1056 mutations + orphan check (a few minutes)
                         # ⚠️ REWRITES the 160 money/authority modules it mutates IN PLACE (138 under
                         # apps/qr/lib, plus create-share-intent, setup-intent and board routes,
                         # plus EIGHTEEN components — TableCartProvider.tsx, menu/YourUsual.tsx,
                         ...
                         # staff/OrderPad.tsx (Phase 2c), COMPONENTS in the set since M46 — plus
                         # packages/db/src/schemas.ts) and restores them.
                         # ⚠️ 138+3+18+1=160, and THIS ENUMERATION IS THE OPERATOR'S ONLY LIST of files
