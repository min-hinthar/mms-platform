...
pnpm verify:slice        # the MECHANICAL pre-PR gate: money-path coverage guard (a changed money
                         ...
                         # + photo-filter grep + gate + 467 mutations + orphan check (a few minutes)
                         # ⚠️ REWRITES the 92 money/authority modules it mutates IN PLACE (82 under
                         ...
                         # ⚠️ 82+3+6+1=92, and THIS ENUMERATION IS THE OPERATOR'S ONLY LIST of files
