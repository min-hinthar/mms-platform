...
pnpm verify:slice        # the MECHANICAL pre-PR gate: money-path coverage guard (a changed money
                         ...
                         # + photo-filter grep + gate + 748 mutations + orphan check (a few minutes)
                         # ⚠️ REWRITES the 131 money/authority modules it mutates IN PLACE (115 under
                         ...
                         # ⚠️ 115+3+12+1=131, and THIS ENUMERATION IS THE OPERATOR'S ONLY LIST of files
