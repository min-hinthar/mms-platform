...
pnpm verify:slice        # the MECHANICAL pre-PR gate: money-path coverage guard (a changed money
                         ...
                         # + photo-filter grep + gate + 665 mutations + orphan check (a few minutes)
                         # ⚠️ REWRITES the 119 money/authority modules it mutates IN PLACE (106 under
                         ...
                         # ⚠️ 106+3+9+1=119, and THIS ENUMERATION IS THE OPERATOR'S ONLY LIST of files
