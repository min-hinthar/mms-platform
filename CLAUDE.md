...
pnpm verify:slice        # the MECHANICAL pre-PR gate: money-path coverage guard (a changed money
                         ...
                         # + photo-filter grep + gate + 600 mutations + orphan check (a few minutes)
                         # ⚠️ REWRITES the 112 money/authority modules it mutates IN PLACE (99 under
                         ...
                         # ⚠️ 99+3+9+1=112, and THIS ENUMERATION IS THE OPERATOR'S ONLY LIST of files
