...
pnpm verify:slice        # the MECHANICAL pre-PR gate: money-path coverage guard (a changed money
                         ...
                         # + photo-filter grep + gate + 488 mutations + orphan check (a few minutes)
                         # ⚠️ REWRITES the 95 money/authority modules it mutates IN PLACE (85 under
                         ...
                         # ⚠️ 85+3+6+1=95, and THIS ENUMERATION IS THE OPERATOR'S ONLY LIST of files
