...
pnpm verify:slice        # the MECHANICAL pre-PR gate: money-path coverage guard (a changed money
                         ...
                         # + photo-filter grep + gate + 645 mutations + orphan check (a few minutes)
                         # ⚠️ REWRITES the 113 money/authority modules it mutates IN PLACE (100 under
                         ...
                         # ⚠️ 100+3+9+1=113, and THIS ENUMERATION IS THE OPERATOR'S ONLY LIST of files
