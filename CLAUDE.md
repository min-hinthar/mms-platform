...
pnpm verify:slice        # the MECHANICAL pre-PR gate: money-path coverage guard (a changed money
                         ...
                         # + photo-filter grep + gate + 694 mutations + orphan check (a few minutes)
                         # ⚠️ REWRITES the 125 money/authority modules it mutates IN PLACE (110 under
                         # apps/qr/lib, plus create-share-intent, setup-intent and board routes,
                         # plus ELEVEN components — TableCartProvider.tsx, menu/YourUsual.tsx,
                         # staff/TicketText.tsx, staff/Chrome.tsx, staff/StaffPromoControl.tsx,
                         # ReadyBoard.tsx, MergeRedeemer.tsx, staff/TableCard.tsx,
                         # AccountUpgrade.tsx, staff/SettledToday.tsx and staff/DayCash.tsx,
                         # COMPONENTS in the set since M46 — plus
                         # packages/db/src/schemas.ts) and restores them.
                         # ⚠️ 110+3+11+1=125, and THIS ENUMERATION IS THE OPERATOR'S ONLY LIST of files
