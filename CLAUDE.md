...
pnpm verify:slice        # the MECHANICAL pre-PR gate: money-path coverage guard (a changed money
                         ...
                         # + photo-filter grep + gate + 472 mutations + orphan check (a few minutes)
                         # ⚠️ REWRITES the 93 money/authority modules it mutates IN PLACE (83 under
                         ...
                         # ⚠️ 83+3+6+1=93, and THIS ENUMERATION IS THE OPERATOR'S ONLY LIST of files
