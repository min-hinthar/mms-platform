...
pnpm verify:slice        # the MECHANICAL pre-PR gate: money-path coverage guard (a changed money
                         ...
                         # + photo-filter grep + gate + 672 mutations + orphan check (a few minutes)
                         # ⚠️ REWRITES the 121 money/authority modules it mutates IN PLACE (108 under
                         ...
                         # ⚠️ 108+3+9+1=121, and THIS ENUMERATION IS THE OPERATOR'S ONLY LIST of files
