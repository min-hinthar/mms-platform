...
pnpm verify:slice        # the MECHANICAL pre-PR gate: money-path coverage guard (a changed money
                         ...
                         # + photo-filter grep + gate + 531 mutations + orphan check (a few minutes)
                         # ⚠️ REWRITES the 102 money/authority modules it mutates IN PLACE (92 under
                         ...
                         # ⚠️ 92+3+6+1=102, and THIS ENUMERATION IS THE OPERATOR'S ONLY LIST of files
