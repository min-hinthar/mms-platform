...
pnpm verify:slice        # the MECHANICAL pre-PR gate: money-path coverage guard (a changed money
                         ...
                         # + photo-filter grep + gate + 517 mutations + orphan check (a few minutes)
                         # ⚠️ REWRITES the 96 money/authority modules it mutates IN PLACE (86 under
                         ...
                         # ⚠️ 86+3+6+1=96, and THIS ENUMERATION IS THE OPERATOR'S ONLY LIST of files
