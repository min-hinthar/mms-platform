...
>
> **334 mutants at the time (376 today)**, **1372 qr + 138 ui tests at the time (1582 + 140 today)**, 69 target modules at the time (74 under `apps/qr/lib` today, 81 in all), 97 local
...
>
> **Gate today:** 376 `verify:slice` mutants green · `pnpm check:docs` clean (97 files, 1582 qr tests + 140 ui tests) · CI green · then the two reviewers.
>
