...
>
> **Gate today:** 283 `verify:slice` mutants green · `pnpm check:docs` clean (96 files, 1269 qr tests + 138 ui tests) · CI green · then the two reviewers.
>
...
> queue, catalog-cache "≈$" estimates. 88 mutants at the time (283 today) — and
