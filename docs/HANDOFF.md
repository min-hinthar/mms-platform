...
>
> **Gate today:** 195 `verify:slice` mutants green · `pnpm check:docs` clean (95 files, 821 qr tests +
> 85 ui tests) · CI green · then the two reviewers.
>
...
> queue, catalog-cache "≈$" estimates. 88 mutants at the time (195 today) — and
