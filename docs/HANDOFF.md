...
>
> **Gate today:** 128 `verify:slice` mutants green · `pnpm check:docs` clean (94 files, 620 qr tests +
...
> queue, catalog-cache "≈$" estimates. 88 mutants at the time (128 today) — and
