...
>
> **334 mutants at the time (407 today)**, **1372 qr + 138 ui tests at the time (1580 + 140 today)**, 69 target modules at the time (74 under `apps/qr/lib` today, 82 in all), 97 local
...
>
> **Gate today:** 407 `verify:slice` mutants green · `pnpm check:docs` clean (98 files, 1580 qr tests + 140 ui tests) · CI green · then the two reviewers.
>
...
> queue, catalog-cache "≈$" estimates. 88 mutants at the time (407 today) — and
