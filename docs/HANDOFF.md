...
>
> **Gate today:** 175 `verify:slice` mutants green · `pnpm check:docs` clean (94 files, 745 qr tests +
...
> queue, catalog-cache "≈$" estimates. 88 mutants at the time (175 today) — and
