...
> ### Counts on this head, measured not transcribed
>
> **334 mutants at the time (670 today)**, **1372 qr + 138 ui tests at the time (2520 + 142 today)**, 69 target modules at the time (107 under `apps/qr/lib` today, 120 in all), 97 local
...
>
> **Gate today:** 670 `verify:slice` mutants green · `pnpm check:docs` clean (99 files, 2520 qr tests + 142 ui tests) · CI green · then the two reviewers.
>
