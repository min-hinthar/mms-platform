...
> `surfaces/*`), 558 across 105 modules.
>
...
>
> **558 `verify:slice` mutants** · **105 target modules** (95 under `apps/qr/lib`, 3 API routes,
...
> ### Counts on this head, measured not transcribed
>
> **334 mutants at the time (558 today)**, **1372 qr + 138 ui tests at the time (2189 + 142 today)**, 69 target modules at the time (95 under `apps/qr/lib` today, 105 in all), 97 local
...
>
> **Gate today:** 558 `verify:slice` mutants green · `pnpm check:docs` clean (98 files, 2189 qr tests + 142 ui tests) · CI green · then the two reviewers.
>
...
> queue, catalog-cache "≈$" estimates. 88 mutants at the time (558 today) — and
