...
>
> **Gate today:** 211 `verify:slice` mutants green · `pnpm check:docs` clean (95 files, 1009 qr tests +
...
> queue, catalog-cache "≈$" estimates. 88 mutants at the time (211 today) — and
