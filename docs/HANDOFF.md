...
>
> **334 mutants at the time (361 today)**, **1372 qr + 138 ui tests at the time (1512 + 140 today)**, 69 target modules at the time (69 under `apps/qr/lib` today, 76 in all), 97 local
...
>
> **Gate today:** 361 `verify:slice` mutants green · `pnpm check:docs` clean (97 files, 1536 qr tests + 140 ui tests) · CI green · then the two reviewers.
>
...
> queue, catalog-cache "≈$" estimates. 88 mutants at the time (361 today) — and
