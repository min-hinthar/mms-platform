...
>
> **Gate today:** 836 `verify:slice` mutants · 146 target modules (127 `apps/qr/lib`, 3 API routes,
...
>
> **836 `verify:slice` mutants** · **146 target modules** (127 under `apps/qr/lib`, 3 API routes,
> 15 components, 1 in `packages/db`) · **1787 qr + 142 ui tests at the time (3432 + 188 today)** ·
...
> ### Counts on this head, measured not transcribed
>
> **334 mutants at the time (836 today)**, **1372 qr + 138 ui tests at the time (3432 + 188 today)**, 69 target modules at the time (127 under `apps/qr/lib` today, 146 in all), 97 local
...
>
> **Gate today:** 836 `verify:slice` mutants green · `pnpm check:docs` clean (100 files, 3432 qr tests + 188 ui tests) · CI green · then the two reviewers.
>
...
> queue, catalog-cache "≈$" estimates. 88 mutants at the time (836 today) — and
