...
>
> **Gate today:** 216 `verify:slice` mutants green · `pnpm check:docs` clean (95 files, 1023 qr tests +
...
> queue, catalog-cache "≈$" estimates. 88 mutants at the time (216 today) — and
