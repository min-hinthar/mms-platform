...
>
> **Gate today:** 222 `verify:slice` mutants green · `pnpm check:docs` clean (95 files, 1036 qr tests +
...
> queue, catalog-cache "≈$" estimates. 88 mutants at the time (222 today) — and
