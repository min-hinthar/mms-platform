...
> ### Counts on this head, measured not transcribed
>
> **334 mutants at the time (564 today)**, **1372 qr + 138 ui tests at the time (2198 + 142 today)**, 69 target modules at the time (96 under `apps/qr/lib` today, 107 in all), 97 local
...
>
> **Gate today:** 564 `verify:slice` mutants green · `pnpm check:docs` clean (98 files, 2198 qr tests + 142 ui tests) · CI green · then the two reviewers.
>
