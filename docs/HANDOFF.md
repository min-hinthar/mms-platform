...
>
> **509 `verify:slice` mutants** · **96 target modules** (86 under `apps/qr/lib`, 3 API routes,
...
> ### Counts on this head, measured not transcribed
>
> **334 mutants at the time (509 today)**, **1372 qr + 138 ui tests at the time (2090 + 142 today)**, 69 target modules at the time (86 under `apps/qr/lib` today, 96 in all), 97 local
...
>
> **Gate today:** 509 `verify:slice` mutants green · `pnpm check:docs` clean (98 files, 2090 qr tests + 142 ui tests) · CI green · then the two reviewers.
>
...
> queue, catalog-cache "≈$" estimates. 88 mutants at the time (509 today) — and
