...
>
> **Gate today:** 1108 `verify:slice` mutants · 163 target modules (138 `apps/qr/lib`, 3 API routes,
...
>
> **1108 `verify:slice` mutants** · **163 target modules** (138 under `apps/qr/lib`, 3 API routes,
> 21 components, 1 in `packages/db`) · **1787 qr + 142 ui tests at the time (3993 + 228 today)** ·
...
> ### Counts on this head, measured not transcribed
>
> **334 mutants at the time (1108 today)**, **1372 qr + 138 ui tests at the time (3993 + 228 today)**, 69 target modules at the time (138 under `apps/qr/lib` today, 163 in all), 97 local
...
>
> **Gate today:** 1108 `verify:slice` mutants green · `pnpm check:docs` clean (100 files, 3993 qr tests + 228 ui tests) · CI green · then the two reviewers.
>
...
> queue, catalog-cache "≈$" estimates. 88 mutants at the time (1108 today) — and
