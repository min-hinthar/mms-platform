...
>
> **Gate today:** 315 `verify:slice` mutants green · `pnpm check:docs` clean (97 files, 1323 qr tests + 138 ui tests) · CI green · then the two reviewers.
>
...
> queue, catalog-cache "≈$" estimates. 88 mutants at the time (315 today) — and
