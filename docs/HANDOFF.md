...
>
> **665 `verify:slice` mutants** · **119 target modules** (106 under `apps/qr/lib`, 3 API routes,
...
> ### Counts on this head, measured not transcribed
>
> **334 mutants at the time (665 today)**, **1372 qr + 138 ui tests at the time (2498 + 142 today)**, 69 target modules at the time (106 under `apps/qr/lib` today, 119 in all), 97 local
...
>
> **Gate today:** 665 `verify:slice` mutants green · `pnpm check:docs` clean (99 files, 2498 qr tests + 142 ui tests) · CI green · then the two reviewers.
>
...
> queue, catalog-cache "≈$" estimates. 88 mutants at the time (665 today) — and
