...
> ### Counts on this head, measured not transcribed
>
> **334 mutants at the time (472 today)**, **1372 qr + 138 ui tests at the time (1968 + 142 today)**, 69 target modules at the time (83 under `apps/qr/lib` today, 93 in all), 97 local
...
>
> **Gate today:** 472 `verify:slice` mutants green · `pnpm check:docs` clean (98 files, 1968 qr tests + 142 ui tests) · CI green · then the two reviewers.
>
