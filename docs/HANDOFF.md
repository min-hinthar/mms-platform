...
>
> **Gate today:** 174 `verify:slice` mutants green · `pnpm check:docs` clean (94 files, 743 qr tests +
...
> queue, catalog-cache "≈$" estimates. 88 mutants at the time (174 today) — and
