...
> "688 that day (700 today)" here reddens step one of the fast lane. The date qualifies the test
...
>
> **700 `verify:slice` mutants** · **126 target modules** (110 under `apps/qr/lib`, 3 API routes,
...
> ### Counts on this head, measured not transcribed
>
> **334 mutants at the time (700 today)**, **1372 qr + 138 ui tests at the time (2606 + 142 today)**, 69 target modules at the time (110 under `apps/qr/lib` today, 126 in all), 97 local
...
>
> **Gate today:** 700 `verify:slice` mutants green · `pnpm check:docs` clean (99 files, 2606 qr tests + 142 ui tests) · CI green · then the two reviewers.
>
...
> queue, catalog-cache "≈$" estimates. 88 mutants at the time (700 today) — and
