...
>
> **Gate today:** 228 `verify:slice` mutants green · `pnpm check:docs` clean (96 files, 1102 qr tests + 133 ui tests) · CI green · then the two reviewers.
>
...
> queue, catalog-cache "≈$" estimates. 88 mutants at the time (228 today) — and
