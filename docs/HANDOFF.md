...
> 15 components, 1 in `packages/db`) · **1787 qr + 142 ui tests at the time (3619 + 211 today)** ·
...
> ### Counts on this head, measured not transcribed
>
> **334 mutants at the time (885 today)**, **1372 qr + 138 ui tests at the time (3619 + 211 today)**, 69 target modules at the time (132 under `apps/qr/lib` today, 151 in all), 97 local
...
>
> **Gate today:** 885 `verify:slice` mutants green · `pnpm check:docs` clean (100 files, 3619 qr tests + 211 ui tests) · CI green · then the two reviewers.
>
