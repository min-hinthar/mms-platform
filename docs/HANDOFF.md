...
>
> **Gate today:** 196 `verify:slice` mutants green · `pnpm check:docs` clean (95 files, 859 qr tests +
...
> queue, catalog-cache "≈$" estimates. 88 mutants at the time (196 today) — and
