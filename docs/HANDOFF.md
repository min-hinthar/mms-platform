...
>
> **Gate today:** 218 `verify:slice` mutants green · `pnpm check:docs` clean (95 files, 1027 qr tests +
...
> queue, catalog-cache "≈$" estimates. 88 mutants at the time (218 today) — and
