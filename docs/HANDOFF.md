...
>
> **547 `verify:slice` mutants** · **103 target modules** (93 under `apps/qr/lib`, 3 API routes,
...
> ### Counts on this head, measured not transcribed
>
> **334 mutants at the time (547 today)**, **1372 qr + 138 ui tests at the time (2169 + 142 today)**, 69 target modules at the time (93 under `apps/qr/lib` today, 103 in all), 97 local
...
>
> **Gate today:** 547 `verify:slice` mutants green · `pnpm check:docs` clean (98 files, 2169 qr tests + 142 ui tests) · CI green · then the two reviewers.
>
...
> queue, catalog-cache "≈$" estimates. 88 mutants at the time (547 today) — and
