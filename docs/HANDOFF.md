...
>
> **Gate today:** 753 `verify:slice` mutants · 132 target modules (116 `apps/qr/lib`, 3 API routes,
...
>
> **753 `verify:slice` mutants** · **132 target modules** (116 under `apps/qr/lib`, 3 API routes,
> 12 components, 1 in `packages/db`) · **1787 qr + 142 ui tests at the time (2953 + 146 today)** ·
...
> ### Counts on this head, measured not transcribed
>
> **334 mutants at the time (753 today)**, **1372 qr + 138 ui tests at the time (2953 + 146 today)**, 69 target modules at the time (116 under `apps/qr/lib` today, 132 in all), 97 local
...
>
> **Gate today:** 753 `verify:slice` mutants green · `pnpm check:docs` clean (100 files, 2953 qr tests + 146 ui tests) · CI green · then the two reviewers.
>
...
> queue, catalog-cache "≈$" estimates. 88 mutants at the time (753 today) — and
