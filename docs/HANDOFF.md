...
>
> **Gate today:** 215 `verify:slice` mutants green · `pnpm check:docs` clean (95 files, 1021 qr tests +
...
> queue, catalog-cache "≈$" estimates. 88 mutants at the time (215 today) — and
