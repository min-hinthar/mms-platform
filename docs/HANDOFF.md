...
> ### Counts on this head, measured not transcribed
>
> **334 mutants at the time (482 today)**, **1372 qr + 138 ui tests at the time (2030 + 142 today)**, 69 target modules at the time (85 under `apps/qr/lib` today, 95 in all), 97 local
...
>
> **Gate today:** 482 `verify:slice` mutants green · `pnpm check:docs` clean (98 files, 2030 qr tests + 142 ui tests) · CI green · then the two reviewers.
>
