...
>
> **Gate today:** 172 `verify:slice` mutants green · `pnpm check:docs` clean (94 files, 741 qr tests +
...
> queue, catalog-cache "≈$" estimates. 88 mutants at the time (172 today) — and
