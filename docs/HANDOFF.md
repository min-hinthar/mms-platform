...
>
> **Gate today:** 200 `verify:slice` mutants green · `pnpm check:docs` clean (95 files, 931 qr tests +
...
> queue, catalog-cache "≈$" estimates. 88 mutants at the time (200 today) — and
