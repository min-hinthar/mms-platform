...
>
> **Gate today:** 184 `verify:slice` mutants green · `pnpm check:docs` clean (95 files, 788 qr tests +
...
> queue, catalog-cache "≈$" estimates. 88 mutants at the time (184 today) — and
