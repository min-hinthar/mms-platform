...
> ### Counts on this head, measured not transcribed
>
> **334 mutants at the time (522 today)**, **1372 qr + 138 ui tests at the time (2109 + 142 today)**, 69 target modules at the time (87 under `apps/qr/lib` today, 97 in all), 97 local
...
>
> **Gate today:** 522 `verify:slice` mutants green · `pnpm check:docs` clean (98 files, 2109 qr tests + 142 ui tests) · CI green · then the two reviewers.
>
