...
>
> **636 `verify:slice` mutants** · **112 target modules** (99 under `apps/qr/lib`, 3 API routes,
...
> ### Counts on this head, measured not transcribed
>
> **334 mutants at the time (636 today)**, **1372 qr + 138 ui tests at the time (2374 + 142 today)**, 69 target modules at the time (99 under `apps/qr/lib` today, 112 in all), 97 local
...
>
> **Gate today:** 636 `verify:slice` mutants green · `pnpm check:docs` clean (98 files, 2374 qr tests + 142 ui tests) · CI green · then the two reviewers.
>
...
> queue, catalog-cache "≈$" estimates. 88 mutants at the time (636 today) — and
