...
>
> **334 mutants at the time (370 today)**, **1372 qr + 138 ui tests at the time (1558 + 142 today)**, 69 target modules at the time (70 under `apps/qr/lib` today, 78 in all), 97 local
...
> written as that, not as anonymity — **P6a–P6g** in OPEN-ITEMS carry the residuals, of which **P6a**
...
>
> **Gate today:** 370 `verify:slice` mutants green · `pnpm check:docs` clean (97 files, 1558 qr tests + 142 ui tests) · CI green · then the two reviewers.
>
...
> queue, catalog-cache "≈$" estimates. 88 mutants at the time (370 today) — and
