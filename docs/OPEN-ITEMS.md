...
| M11 | low | Pure-grocery basket inside a **split**: `create-share-intent` derives the payer tip from their net share regardless of composition (splits are dine-in; a pure-grocery split is theoretical). Align if S4 group-grocery ever becomes real. | open | W1a note |
