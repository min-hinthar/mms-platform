 ...
 *  while 5 fetches ran. Mirrors FloorDetailLive under P7·1b: the staff bar (a circle, the title,
 *  the trailing controls) → party card → order card, in the same column the live view uses. */
    ...
    <main className="staff-main">
      ...
      <div aria-hidden>
        ...
        <div className="staff-col" style={{ maxWidth: 640, margin: "0 auto" }}>
          <Skeleton width={200} height={16} radius={6} style={{ margin: "0 0 20px" }} />
