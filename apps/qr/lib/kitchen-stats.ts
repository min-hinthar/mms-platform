 ...
 * 0: the served rail's capped sentence takes that count as its denominator, and an invented zero
 * read "Showing the last 40 of 0 served today" over a full rail. A genuine zero (nothing served yet)
 * stays 0 — the Avg cell draws "—" for both, and only the sentence tells them apart.
 */
...
/** Which sentence a FULL rail shows: the day's count when the stats answered, else the honest form. */
