...
pnpm verify:slice                      # the MECHANICAL money-path gate: coverage guard + 754 semantic
                                       # mutations (each MUST turn its owning suite red) + orphan check.
                                       # ⚠️ rewrites the 132 money/authority modules it mutates IN PLACE
                                       # (116 under apps/qr/lib, plus the create-share-intent, setup-intent
                                       # and board routes, plus TWELVE components — TableCartProvider.tsx,
                                       ...
                                       # staff/SettledToday.tsx, staff/DayCash.tsx and Checkout.tsx — plus
                                       # packages/db/src/schemas.ts: 110+3+12+1=126) and restores them.
