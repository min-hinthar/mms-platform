...
pnpm verify:slice                      # the MECHANICAL money-path gate: coverage guard + 436 semantic
                                       # mutations (each MUST turn its owning suite red) + orphan check.
                                       # ⚠️ rewrites the 85 money/authority modules it mutates IN PLACE
                                       # (75 under apps/qr/lib, plus the create-share-intent, setup-intent
                                       ...
                                       # packages/db/src/schemas.ts: 75+3+6+1=85) and restores them.
