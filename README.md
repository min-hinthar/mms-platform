...
pnpm verify:slice                      # the MECHANICAL money-path gate: coverage guard + 384 semantic
                                       # mutations (each MUST turn its owning suite red) + orphan check.
                                       # ⚠️ rewrites the 79 money/authority modules it mutates IN PLACE
                                       # (72 under apps/qr/lib, plus the create-share-intent, setup-intent
