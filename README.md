...
pnpm verify:slice                      # the MECHANICAL money-path gate: coverage guard + 748 semantic
                                       # mutations (each MUST turn its owning suite red) + orphan check.
                                       # ⚠️ rewrites the 131 money/authority modules it mutates IN PLACE
                                       # (115 under apps/qr/lib, plus the create-share-intent, setup-intent
