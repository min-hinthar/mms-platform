...
pnpm verify:slice                      # the MECHANICAL money-path gate: coverage guard + 355 semantic
                                       # mutations (each MUST turn its owning suite red) + orphan check.
                                       # ⚠️ rewrites the 76 money/authority modules it mutates IN PLACE
                                       # (69 under apps/qr/lib, plus the create-share-intent, setup-intent
