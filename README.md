...
pnpm verify:slice                      # the MECHANICAL money-path gate: coverage guard + 259 semantic
                                       # mutations (each MUST turn its owning suite red) + orphan check.
                                       # ⚠️ rewrites the 59 money/authority modules it mutates IN PLACE
                                       # (56 under apps/qr/lib, plus the create-share-intent,
