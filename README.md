...
pnpm verify:slice                      # the MECHANICAL money-path gate: coverage guard + 578 semantic
                                       # mutations (each MUST turn its owning suite red) + orphan check.
                                       # ⚠️ rewrites the 108 money/authority modules it mutates IN PLACE
                                       # (96 under apps/qr/lib, plus the create-share-intent, setup-intent
                                       # and board routes, plus EIGHT components — TableCartProvider.tsx,
                                       # menu/YourUsual.tsx, staff/TicketText.tsx, staff/Chrome.tsx,
                                       # staff/StaffPromoControl.tsx, ReadyBoard.tsx,
                                       # MergeRedeemer.tsx and staff/TableCard.tsx — plus
                                       # packages/db/src/schemas.ts: 96+3+8+1=108) and restores them.
