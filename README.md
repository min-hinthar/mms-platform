...
pnpm verify:slice                      # the MECHANICAL money-path gate: coverage guard + 665 semantic
                                       # mutations (each MUST turn its owning suite red) + orphan check.
                                       # ⚠️ rewrites the 119 money/authority modules it mutates IN PLACE
                                       # (106 under apps/qr/lib, plus the create-share-intent, setup-intent
