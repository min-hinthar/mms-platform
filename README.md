...
pnpm verify:slice                      # the MECHANICAL money-path gate: coverage guard + 610 semantic
                                       # mutations (each MUST turn its owning suite red) + orphan check.
                                       # ⚠️ rewrites the 112 money/authority modules it mutates IN PLACE
                                       # (99 under apps/qr/lib, plus the create-share-intent, setup-intent
                                       ...
                                       # packages/db/src/schemas.ts: 99+3+9+1=112) and restores them.
