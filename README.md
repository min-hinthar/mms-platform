...
pnpm verify:slice                      # the MECHANICAL money-path gate: coverage guard + 239 semantic
                                       # mutations (each MUST turn its owning suite red) + orphan check.
                                       # ⚠️ rewrites the 58 money/authority modules it mutates IN PLACE
                                       # (55 under apps/qr/lib, plus the create-share-intent,
