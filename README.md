...
pnpm verify:slice                      # the MECHANICAL money-path gate: coverage guard + 988 semantic
                                       # mutations (each MUST turn its owning suite red) + orphan check.
                                       # ⚠️ rewrites the 158 money/authority modules it mutates IN PLACE
                                       # (138 under apps/qr/lib, plus the create-share-intent, setup-intent
                                       # and board routes, plus SIXTEEN components — TableCartProvider.tsx,
                                       ...
                                       # staff/CloseSecureTabButton.tsx and staff/TerminalSettle.tsx — plus
                                       # packages/db/src/schemas.ts: 138+3+16+1=158) and restores them.
