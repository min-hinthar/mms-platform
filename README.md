...
pnpm verify:slice                      # the MECHANICAL money-path gate: coverage guard + 836 semantic
                                       # mutations (each MUST turn its owning suite red) + orphan check.
                                       # ⚠️ rewrites the 146 money/authority modules it mutates IN PLACE
                                       # (127 under apps/qr/lib, plus the create-share-intent, setup-intent
                                       # and board routes, plus FIFTEEN components — TableCartProvider.tsx,
                                       ...
                                       # PaymentSection.tsx, staff/CashSettleButton.tsx and
                                       # staff/CloseSecureTabButton.tsx — plus packages/db/src/schemas.ts:
                                       # 127+3+15+1=146) and restores them.
