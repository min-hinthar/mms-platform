...
pnpm verify:slice                      # the MECHANICAL money-path gate: coverage guard + 472 semantic
                                       # mutations (each MUST turn its owning suite red) + orphan check.
                                       # ⚠️ rewrites the 93 money/authority modules it mutates IN PLACE
                                       # (83 under apps/qr/lib, plus the create-share-intent, setup-intent
