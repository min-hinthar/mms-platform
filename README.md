...
pnpm verify:slice                      # the MECHANICAL money-path gate: coverage guard + 467 semantic
                                       # mutations (each MUST turn its owning suite red) + orphan check.
                                       # ⚠️ rewrites the 92 money/authority modules it mutates IN PLACE
                                       # (82 under apps/qr/lib, plus the create-share-intent, setup-intent
                                       ...
                                       # packages/db/src/schemas.ts: 82+3+6+1=92) and restores them.
