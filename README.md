...
pnpm verify:slice                      # the MECHANICAL money-path gate: coverage guard + 509 semantic
                                       # mutations (each MUST turn its owning suite red) + orphan check.
                                       # ⚠️ rewrites the 96 money/authority modules it mutates IN PLACE
                                       # (86 under apps/qr/lib, plus the create-share-intent, setup-intent
