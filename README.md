...
pnpm verify:slice                      # the MECHANICAL money-path gate: coverage guard + 334 semantic
                                       # mutations (each MUST turn its owning suite red) + orphan check.
                                       # ⚠️ rewrites the 69 money/authority modules it mutates IN PLACE
                                       # (64 under apps/qr/lib, plus the create-share-intent, setup-intent
