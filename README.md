...
**Build:** M0 · M2–M4 · S1–S4 · R1–R9 · J0–J6 ✅ (M1 🟡 — code done, owner-blocked infra tail) — shipped through **W22b** (installed-native PWA · the expanding live order chip) · **Gate:** 671 qr tests + 41 ui tests · 144 `verify:slice` mutants · **Stack:** $0/mo software (Stripe per-txn only)
...
pnpm verify:slice                      # the MECHANICAL money-path gate: coverage guard + 144 semantic
