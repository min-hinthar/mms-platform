...
pnpm verify:slice                      # the MECHANICAL money-path gate: coverage guard + 531 semantic
                                       # mutations (each MUST turn its owning suite red) + orphan check.
                                       # ⚠️ rewrites the 102 money/authority modules it mutates IN PLACE
                                       # (92 under apps/qr/lib, plus the create-share-intent, setup-intent
                                       ...
                                       # packages/db/src/schemas.ts: 92+3+6+1=102) and restores them.
