...
pnpm verify:slice                      # the MECHANICAL money-path gate: coverage guard + 265 semantic
                                       # mutations (each MUST turn its owning suite red) + orphan check.
                                       # ⚠️ rewrites the 62 money/authority modules it mutates IN PLACE
                                       # (59 under apps/qr/lib, plus the create-share-intent,
