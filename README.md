...
pnpm verify:slice                      # the MECHANICAL money-path gate: coverage guard + 792 semantic
                                       # mutations (each MUST turn its owning suite red) + orphan check.
                                       # ⚠️ rewrites the 139 money/authority modules it mutates IN PLACE
                                       # (122 under apps/qr/lib, plus the create-share-intent, setup-intent
                                       # and board routes, plus THIRTEEN components — TableCartProvider.tsx,
                                       ...
                                       # staff/SettledToday.tsx, staff/DayCash.tsx, Checkout.tsx and
                                       # PaymentSection.tsx — plus packages/db/src/schemas.ts:
                                       # 122+3+13+1=139) and restores them.
