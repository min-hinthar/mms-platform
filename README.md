...
pnpm verify:slice                      # the MECHANICAL money-path gate: coverage guard + 570 semantic
                                       # mutations (each MUST turn its owning suite red) + orphan check.
                                       # ⚠️ rewrites the 107 money/authority modules it mutates IN PLACE
                                       # (96 under apps/qr/lib, plus the create-share-intent, setup-intent
                                       # and board routes, plus SEVEN components — TableCartProvider.tsx,
                                       # menu/YourUsual.tsx, staff/TicketText.tsx, staff/Chrome.tsx,
                                       # staff/StaffPromoControl.tsx, ReadyBoard.tsx and
                                       # MergeRedeemer.tsx — plus
                                       # packages/db/src/schemas.ts: 96+3+7+1=107) and restores them.
