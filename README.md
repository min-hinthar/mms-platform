...
pnpm verify:slice                      # the MECHANICAL money-path gate: coverage guard + 1056 semantic
                                       # mutations (each MUST turn its owning suite red) + orphan check.
                                       # ⚠️ rewrites the 160 money/authority modules it mutates IN PLACE
                                       # (138 under apps/qr/lib, plus the create-share-intent, setup-intent
                                       # and board routes, plus EIGHTEEN components — TableCartProvider.tsx,
                                       ...
                                       # staff/FloorDetailLive.tsx and staff/OrderPad.tsx — plus
                                       # packages/db/src/schemas.ts: 138+3+18+1=160) and restores them.
