...
pnpm verify:slice                      # the MECHANICAL money-path gate: coverage guard + 646 semantic
                                       # mutations (each MUST turn its owning suite red) + orphan check.
                                       # ⚠️ rewrites the 113 money/authority modules it mutates IN PLACE
                                       # (100 under apps/qr/lib, plus the create-share-intent, setup-intent
