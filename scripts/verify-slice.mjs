...
const MUTANTS = [
  ...
  {
    id: "manual-capture/dropped-notice-says-refunded",
    file: "apps/qr/lib/manual-capture.ts",
    suite: "lib/manual-capture.test.ts",
    why: "W23c — the entire point of cancelling a hold rather than refunding a charge is that nothing appears on the statement. Telling the guest they were 'refunded' sends them watching for money that was never taken, and turns the feature's best property into a support conversation.",
    find: "off your order and you weren’t charged for it.",
    replace: "off your order and has been refunded to you.",
  },
  {
    ...
    find: '      return { kind: "retry", note: "void failed" };',
    replace: '      console.error("[manual-capture] proceeding despite void failure");',
  },
  {
    ...
    find: "  const gone = await unavailableLines(cartId);",
    replace: "  const gone = [] as Awaited<ReturnType<typeof unavailableLines>>;",
  },
  {
