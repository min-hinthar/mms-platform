...
const MUTANTS = [
  ...
  },
  {
    ...
    find: "  return p.flying + p.unseen + p.unconfirmed + p.lost === 0;",
    replace: "  return p.flying + p.unconfirmed + p.lost === 0;",
  },
  {
  ...
  },
  {
    ...
    find: '  if (res === "threw") return { kind: "unknown" };',
    replace:
