...
const MUTANTS = [
  ...
  },
  {
    ...
    find: "      explainedFreezeRef.current = explanationHolds(explainedByRefusal(refusal.cause), {",
  ...
  },
  {
    ...
    find: '    if (!settling && explainedFreezeRef.current === "settling") explainedFreezeRef.current = null;',
    replace: "",
  },
  {
  ...
  },
  {
    ...
    find: '    if (!locked && explainedFreezeRef.current === "locked") explainedFreezeRef.current = null;',
    replace: "",
  },
  {
