...
const MUTANTS = [
  ...
  },
  {
    ...
    find: "    if (claimHeld) await releaseSettlement(cartId);",
  ...
  },
  {
    ...
    find: '      await releaseSettlement(cartId);\n      return "unavailable";\n    }\n    // The freeze is already ours',
  ...
  },
  {
    ...
    find: "    if (!live) return standDown(cartId);",
  ...
  },
  {
    ...
    find: "    if (!claimed) return standDown(cartId);",
