...
const MUTANTS = [
  ...
  },
  {
    ...
    find: "  if (!input.entering) return false;",
    replace: "  if (false) return false;",
  },
  {
    ...
    find: "  return freezeRank(input.explained) >= freezeRank(input.axis);",
    replace: "  return true;",
  },
  {
  ...
  },
  {
    ...
    find: '  if (cause === "settling") return "settling";\n  return null;',
    replace: '  if (cause === "settling") return "settling";\n  return "locked";',
  },
  {
  ...
  },
  {
    ...
    find: "      explainedFreezeRef.current = viewIsCurrent ? explainedByRefusal(refusal.cause) : null;",
    replace: "      explainedFreezeRef.current = null;",
  },
  {
    ...
    find: "      explainedFreezeRef.current = viewIsCurrent ? explainedByRefusal(refusal.cause) : null;",
    replace: "      explainedFreezeRef.current = explainedByRefusal(refusal.cause);",
  },
  {
    ...
    find: "    if (!settling) explainedFreezeRef.current = null;",
    replace: "",
  },
  {
    ...
    find: "  return freezeRank(input.explained) >= freezeRank(input.axis);",
    replace: "  return input.explained === input.axis;",
  },
  {
  ...
  },
  {
    ...
    find: "    if (!locked) explainedFreezeRef.current = null;",
    replace: "",
  },
  {
